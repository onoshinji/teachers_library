...
#
# # 所見例作成用データ
# Post.create(user_id: User.find(3).id, title: '生活面における所見例', content: '生活に関すること',  grade: '６年生', subject: '総合', unit: '生活に関すること', kind: '所見例',)
# Post.create(user_id: User.find(3).id, title: '所見例学習', content: '国語「鳥獣戯画」では作者の意図を読み取り、表現の仕方について理解することができました。',  grade: '６年生', subject: '国語', unit: '所見例高学年', kind: '所見例')
# Post.create(user_id: User.find(3).id, title: '所見例学習', content: '国語「カレーライス」では、登場人物の気持ちを読み取り、場面ごとの気持ちの変化をまとめることができました。',  grade: '６年生', subject: '国語', unit: '所見例高学年', kind: '所見例')
# Post.create(user_id: User.find(3).id, title: '所見例学習', content: '「ともだちっていいもんや」では、本当の友達の意味について考え、実生活に生かそうとしていました。',  grade: '５年生', subject: '道徳', unit: '所見例高学年', kind: '所見例')
# Post.create(user_id: User.find(3).id, title: '所見例学習', content: '算数「合同な図形」では、合同な図形の条件を理解し正確に作図できました。',  grade: '５年生', subject: '算数', unit: '所見例算数', kind: '所見例')
# Post.create(user_id: User.find(3).id, title: '所見例学習', content: '理科「電気のはたらき」では、直列つなぎと並列つなぎの特徴について気づき、考察を深めていました。',  grade: '４年生', subject: '理科', unit: '所見例学習全般', kind: '所見例')
# Post.create(user_id: User.find(3).id, title: '所見例学習', content: '電気の',  grade: '４年生', subject: '理科', unit: '所見例学習全般', kind: '所見例')
# Post.create(user_id: User.find(3).id, title: '所見例学習', content: 'con1',  grade: '３年生', subject: '社会', unit: '所見例学習全般', kind: '所見例')
# Post.create(user_id: User.find(4).id, title: '所見例学習', content: 'con1',  grade: '３年生', subject: '社会', unit: '所見例中学年', kind: '所見例')
# Post.create(user_id: User.find(4).id, title: '所見例学習', content: 'con1',  grade: '３年生', subject: '体育', unit: '所見例中学年', kind: '所見例')
# Post.create(user_id: User.find(4).id, title: '所見例学習', content: 'con1',  grade: '３年生', subject: '体育', unit: '所見例中学年', kind: '所見例')
# Post.create(user_id: User.find(4).id, title: '所見例学習', content: 'con1',  grade: '２年生', subject: '体育', unit: '所見例低学年', kind: '所見例')

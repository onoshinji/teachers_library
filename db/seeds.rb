...
#
# # 所見例作成用データ
Post.create(user_id: User.find(3).id, title: '生活面における所見例', content: '生活に関すること',  grade: '６年生', subject: '総合', unit: '生活に関すること', kind: '所見例', ms_office:File.open("./public/ms_office/Csv1.csv"),)
